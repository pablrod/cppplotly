...
*/Rangefont & Family(const std::string &family ) {
    _rangefont.insert({"family", family});
    return *this;
}


Rangefont & Size(const double &size ) {
    _rangefont.insert({"size", size});
    return *this;
}
