...
#include "CppPlotly/Trace/Scatter/Marker/Colorbar.h"
#include "CppPlotly/Trace/Scatter/Marker/Gradient.h"
#include "CppPlotly/Trace/Scatter/Marker/Line.h"
...
Marker & Colorbar(const CppPlotly::Trace::scatter::marker::Colorbar &colorbar ) {
...
Marker & Gradient(const CppPlotly::Trace::scatter::marker::Gradient &gradient ) {
    _marker.insert({"gradient", gradient});
    return *this;
}


Marker & Line(const CppPlotly::Trace::scatter::marker::Line &line ) {
