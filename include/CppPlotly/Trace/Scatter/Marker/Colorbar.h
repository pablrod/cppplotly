...
#include "CppPlotly/Trace/Scatter/Marker/Colorbar/Tickfont.h"
#include "CppPlotly/Trace/Scatter/Marker/Colorbar/Tickformatstop.h"
#include "CppPlotly/Trace/Scatter/Marker/Colorbar/Titlefont.h"
...
Colorbar & Tickfont(const CppPlotly::Trace::scatter::marker::colorbar::Tickfont &tickfont ) {
...
Colorbar & Tickformatstops(const std::vector<CppPlotly::Trace::scatter::marker::colorbar::Tickformatstop> &tickformatstops ) {
...
Colorbar & Titlefont(const CppPlotly::Trace::scatter::marker::colorbar::Titlefont &titlefont ) {
