...
#include "CppPlotly/Trace/Candlestick/Hoverlabel/Font.h"
...
Hoverlabel & Font(const CppPlotly::Trace::candlestick::hoverlabel::Font &font ) {
...
*/Hoverlabel & Split(const bool &split ) {
    _hoverlabel.insert({"split", split});
    return *this;
}
