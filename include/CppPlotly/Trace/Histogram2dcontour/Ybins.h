...
#include "CppPlotly/Trace/Histogram2dcontour/Ybins/ImpliedEdits.h"
...
Ybins & ImpliedEdits(const CppPlotly::Trace::histogram2dcontour::ybins::ImpliedEdits &impliedEdits ) {
