...
#include "CppPlotly/Trace/Histogram2dcontour/Xbins/ImpliedEdits.h"
...
Xbins & ImpliedEdits(const CppPlotly::Trace::histogram2dcontour::xbins::ImpliedEdits &impliedEdits ) {
