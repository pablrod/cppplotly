...
#include "CppPlotly/Trace/Scatterpolar/Marker/Colorbar.h"
#include "CppPlotly/Trace/Scatterpolar/Marker/Gradient.h"
#include "CppPlotly/Trace/Scatterpolar/Marker/Line.h"
...
Marker & Colorbar(const CppPlotly::Trace::scatterpolar::marker::Colorbar &colorbar ) {
...
Marker & Gradient(const CppPlotly::Trace::scatterpolar::marker::Gradient &gradient ) {
    _marker.insert({"gradient", gradient});
    return *this;
}


Marker & Line(const CppPlotly::Trace::scatterpolar::marker::Line &line ) {
