...
*/Insidetextfont & Colorsrc(const std::string &colorsrc ) {
    _insidetextfont.insert({"colorsrc", colorsrc});
    return *this;
}
...
*/Insidetextfont & Familysrc(const std::string &familysrc ) {
    _insidetextfont.insert({"familysrc", familysrc});
    return *this;
}
...
*/Insidetextfont & Sizesrc(const std::string &sizesrc ) {
    _insidetextfont.insert({"sizesrc", sizesrc});
    return *this;
}
    ...
    json11::Json to_json() const {
        return _insidetextfont;
    }

    private:

    json11::Json::object _insidetextfont;
