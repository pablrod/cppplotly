...
#include "CppPlotly/Trace/Parcats/Line/Colorbar.h"
...
Line & Colorbar(const CppPlotly::Trace::parcats::line::Colorbar &colorbar ) {
...
*/Line & Hovertemplate(const std::string &hovertemplate ) {
    _line.insert({"hovertemplate", hovertemplate});
    return *this;
}
