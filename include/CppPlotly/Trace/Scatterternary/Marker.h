...
#include "CppPlotly/Trace/Scatterternary/Marker/Colorbar.h"
#include "CppPlotly/Trace/Scatterternary/Marker/Gradient.h"
#include "CppPlotly/Trace/Scatterternary/Marker/Line.h"
...
Marker & Colorbar(const CppPlotly::Trace::scatterternary::marker::Colorbar &colorbar ) {
...
Marker & Gradient(const CppPlotly::Trace::scatterternary::marker::Gradient &gradient ) {
    _marker.insert({"gradient", gradient});
    return *this;
}


Marker & Line(const CppPlotly::Trace::scatterternary::marker::Line &line ) {
