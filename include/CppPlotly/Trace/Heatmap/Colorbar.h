...
Colorbar & Tickfont(const CppPlotly::Trace::heatmap::colorbar::Tickfont &tickfont ) {
...
Colorbar & Tickformatstops(const std::vector<CppPlotly::Trace::heatmap::colorbar::Tickformatstop> &tickformatstops ) {
