...
*/Labelfont & Family(const std::string &family ) {
    _labelfont.insert({"family", family});
    return *this;
}


Labelfont & Size(const double &size ) {
    _labelfont.insert({"size", size});
    return *this;
}
